...
* Update Auto Release Log adding v3.5.1 info with JPL ([4019f2b](https://github.com/teecke/jenkins-pipeline-library/commit/4019f2b))

#### Docs

* Generate v3.5.0 changelog with JPL ([a1e2066](https://github.com/teecke/jenkins-pipeline-library/commit/a1e2066))
...
* Add mapConfig ([4386144](https://github.com/teecke/jenkins-pipeline-library/commit/4386144))
...
* Set Dockerfile with common library part ([8386373](https://github.com/teecke/jenkins-pipeline-library/commit/8386373))
...
* Remove test files ([e3ec831](https://github.com/teecke/jenkins-pipeline-library/commit/e3ec831))
* Slack message sent based on the right condition ([863133b](https://github.com/teecke/jenkins-pipeline-library/commit/863133b))
* Fix jplCloseRelease branch check ([aa9520e](https://github.com/teecke/jenkins-pipeline-library/commit/aa9520e))
* Add doc ([e477d4a](https://github.com/teecke/jenkins-pipeline-library/commit/e477d4a))
* Message... ([1198dba](https://github.com/teecke/jenkins-pipeline-library/commit/1198dba))
* Syntax error ([1bea7ec](https://github.com/teecke/jenkins-pipeline-library/commit/1bea7ec))
* Parametrize ([885abbc](https://github.com/teecke/jenkins-pipeline-library/commit/885abbc))
* Syntax fix ([0f5d0de](https://github.com/teecke/jenkins-pipeline-library/commit/0f5d0de))
* Add jplNotify ([981c219](https://github.com/teecke/jenkins-pipeline-library/commit/981c219))
* Add jplCloseRelease ([e1b5374](https://github.com/teecke/jenkins-pipeline-library/commit/e1b5374))
* Missing '-m' parameter on git promote ([a18eb35](https://github.com/teecke/jenkins-pipeline-library/commit/a18eb35))
* Fix git promote bug ([0a2e254](https://github.com/teecke/jenkins-pipeline-library/commit/0a2e254))
* Add jplPromote ([7dcdd79](https://github.com/teecke/jenkins-pipeline-library/commit/7dcdd79))
* Syntax error ([0f9b768](https://github.com/teecke/jenkins-pipeline-library/commit/0f9b768))
* Change function sonar ([39aefa4](https://github.com/teecke/jenkins-pipeline-library/commit/39aefa4))
* Fix SonarQube tool name ([8820793](https://github.com/teecke/jenkins-pipeline-library/commit/8820793))
* Define sonarHome ([967138e](https://github.com/teecke/jenkins-pipeline-library/commit/967138e))
* Test ([294e730](https://github.com/teecke/jenkins-pipeline-library/commit/294e730))
* Change sonar tool name variable ([60d6d1c](https://github.com/teecke/jenkins-pipeline-library/commit/60d6d1c))
* Add sonar scanner class ([b3fcc4d](https://github.com/teecke/jenkins-pipeline-library/commit/b3fcc4d))
* Test ([59633ba](https://github.com/teecke/jenkins-pipeline-library/commit/59633ba))
* Test ([35d9355](https://github.com/teecke/jenkins-pipeline-library/commit/35d9355))
* Test ([cbf8e00](https://github.com/teecke/jenkins-pipeline-library/commit/cbf8e00))
* Test ([c5e6e94](https://github.com/teecke/jenkins-pipeline-library/commit/c5e6e94))
* Test ([b224bc7](https://github.com/teecke/jenkins-pipeline-library/commit/b224bc7))
* Test ([ea46ea6](https://github.com/teecke/jenkins-pipeline-library/commit/ea46ea6))
* Add custom build ([63b1e73](https://github.com/teecke/jenkins-pipeline-library/commit/63b1e73))
* Change to default agent ([d959d87](https://github.com/teecke/jenkins-pipeline-library/commit/d959d87))
* Add globals ([292a2e4](https://github.com/teecke/jenkins-pipeline-library/commit/292a2e4))
* Fix sonarScanner ([081e938](https://github.com/teecke/jenkins-pipeline-library/commit/081e938))
* Add sonarScanner function ([87fc565](https://github.com/teecke/jenkins-pipeline-library/commit/87fc565))
* Test ([c25ba69](https://github.com/teecke/jenkins-pipeline-library/commit/c25ba69))
* Add serializable ([1c39e7a](https://github.com/teecke/jenkins-pipeline-library/commit/1c39e7a))
* Test gitPromote ([742b1ce](https://github.com/teecke/jenkins-pipeline-library/commit/742b1ce))
* Add test echo ([b2289c4](https://github.com/teecke/jenkins-pipeline-library/commit/b2289c4))
* Add serializable ([abd16c8](https://github.com/teecke/jenkins-pipeline-library/commit/abd16c8))
* Test ([ffb90cc](https://github.com/teecke/jenkins-pipeline-library/commit/ffb90cc))
* Use global library ([bb610bc](https://github.com/teecke/jenkins-pipeline-library/commit/bb610bc))
* Add gitPromote ([49eef29](https://github.com/teecke/jenkins-pipeline-library/commit/49eef29))
* Test println ([555b57c](https://github.com/teecke/jenkins-pipeline-library/commit/555b57c))
* Fix class ([848e436](https://github.com/teecke/jenkins-pipeline-library/commit/848e436))
* Fix class ([d61978c](https://github.com/teecke/jenkins-pipeline-library/commit/d61978c))
* Add email notify ([8efcc8b](https://github.com/teecke/jenkins-pipeline-library/commit/8efcc8b))
* Add jpl class ([c65bd21](https://github.com/teecke/jenkins-pipeline-library/commit/c65bd21))
* Add global vars ([daba1cb](https://github.com/teecke/jenkins-pipeline-library/commit/daba1cb))
* Initial commit ([2c7c0b5](https://github.com/teecke/jenkins-pipeline-library/commit/2c7c0b5))
